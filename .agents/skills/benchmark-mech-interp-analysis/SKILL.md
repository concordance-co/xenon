...
- `workspaces/<workspace>/[<thread>/]phase_02/docs/02-behavioral-smoke-report.md`
...
After experiments run, record what the result means for the research thread, not just the metric.
...
- `workspaces/<workspace>/[<thread>/]phase_03/docs/03-analysis-plan.md`
  ...
  - expected artifacts
  - key risks
- `workspaces/<workspace>/[<thread>/]phase_03/docs/03-feature-hypotheses.md`
  label-family -> candidate representation/control-state hypotheses
- `workspaces/<workspace>/[<thread>/]phase_03/docs/03-experiment-specs.md`
  2-5 concrete first experiments with method, split, and success criteria
- `workspaces/<workspace>/[<thread>/]phase_03/docs/03-controls-and-splits.md`
  the control plan carried into actual experiments
- `workspaces/<workspace>/[<thread>/]phase_03/docs/03-analysis-summary.json`
  compact structured summary of chosen label families, methods, and next steps
- `workspaces/<workspace>/[<thread>/]phase_03/docs/03-result-triage-log.md`
  one entry per executed experiment, including verdict and routing

Also leave behind:

- `workspaces/<workspace>/[<thread>/]phase_03/docs/03-execution-targets.md`
...
- `workspaces/<workspace>/[<thread>/]phase_03/docs/03-phase-04-entry-criteria.md`
...
- `workspaces/<workspace>/[<thread>/]phase_03/docs/03-response-label-pilot.md`
...
- `workspaces/<workspace>/[<thread>/]phase_03/docs/03-<label>-gold-slice-spec.md`
