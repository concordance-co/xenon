...
long-form planning notes are not active dependencies for this skill.
...
- `workspaces/<workspace>/[<thread>/]phase_01/docs/01-latent-label-spec.md`
  canonical human-readable spec for the benchmark's refined ontology
- `workspaces/<workspace>/[<thread>/]phase_01/docs/01-label-inventory.csv` or `.parquet`
  native labels, their types, and latent-usefulness ratings
- `workspaces/<workspace>/[<thread>/]phase_01/docs/01-labeling-functions.md`
  extracted mechanistic questions, surviving labels, and how each is assigned and validated
- `workspaces/<workspace>/[<thread>/]phase_01/docs/01-confound-audit.md`
  target-vs-nuisance concerns and planned controls
- `workspaces/<workspace>/[<thread>/]phase_01/docs/01-frozen-label-set.csv` or `.parquet`
...
- `workspaces/<workspace>/[<thread>/]phase_01/docs/01-gap-list.md`
  what must be repaired or augmented before deeper work
- `workspaces/<workspace>/[<thread>/]phase_01/docs/01-latent-label-summary.json`
  compact structured summary of the refined ontology, labels, and next action

Optional but useful:

- `workspaces/<workspace>/[<thread>/]phase_01/docs/01-derivability-report.md`
- `workspaces/<workspace>/[<thread>/]phase_01/docs/01-baseline-report.md`
