...
- `workspaces/<workspace>/[<thread>/]phase_00/docs/00-validation-memo.md`
  ...
  - recommendation:
    ...
    - defer / reject
- `workspaces/<workspace>/[<thread>/]phase_00/docs/00-validation-summary.json`
  compact structured summary of the memo
- `workspaces/<workspace>/[<thread>/]phase_00/docs/00-validation-notes.md`
...
- initialize the benchmark sidecar from [methodology/templates/REAL_DATA.md](../../../methodology/templates/REAL_DATA.md)
