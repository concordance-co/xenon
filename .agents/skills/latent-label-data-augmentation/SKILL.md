...
- `workspaces/<workspace>/[<thread>/]phase_02/docs/02-augmentation-plan.md`
  what is being repaired and why
- `workspaces/<workspace>/[<thread>/]phase_02/docs/02-gap-list-resolution.md`
  direct mapping from each gap-list item to the chosen repair move
- `workspaces/<workspace>/[<thread>/]phase_02/docs/02-augmented-data-manifest.json`
  where rewritten, paired, generated, or counterbalanced data now lives
- `workspaces/<workspace>/[<thread>/]phase_02/docs/02-augmentation-report.md`
...
- `workspaces/<workspace>/[<thread>/]phase_02/docs/02-generation-protocol.md`
