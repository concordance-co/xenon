...
- `workspaces/<workspace>/[<thread>/]phase_04/docs/04-intervention-plan.md`
...
- `workspaces/<workspace>/[<thread>/]phase_04/docs/04-site-hypothesis.md`
  why these intervention sites are plausible
- `workspaces/<workspace>/[<thread>/]phase_04/docs/04-pairing-and-controls.md`
  donor-target design, same-label controls, and failure criteria
- `workspaces/<workspace>/[<thread>/]phase_04/docs/04-intervention-summary.json`
