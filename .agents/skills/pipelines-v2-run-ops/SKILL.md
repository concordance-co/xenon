...
1. Identify the workflow file. Common locations are `workflows/<name>/workflow.py`,
   `workflows/<name>/specs/workflow.py`, or
   `workspaces/<workspace>/[<thread>/]phase_XX/specs/workflow.py`.
2. Plan it first:
