...
- [pipelines/interp/synthetic/modal_capture.py](/Users/marshallvyletel/repos/concordance/xenon/pipelines/interp/synthetic/modal_capture.py)
...
- `pipelines/interp/patching/market_patch.py`
- `pipelines/interp/vllm_patching_runner.py`
- `pipelines/interp/patching/modal.py`
- `research/synthetic_market/synthetic_market_patching_analysis.py`

Optional later:

- `scripts/archive/datasets/synthetic_market/prepare_phase18_patching.py`


## `patching/market_patch.py`
