...
#table(
  ...
  [Mean source spend gap], [#pair_fmt(metrics.at("mean_source_tool_spend_pct_gap_baseline"), metrics.at("mean_source_tool_spend_pct_gap_intervention"))], [Lower is better],
  ...
  [Mean source length gap], [#pair_fmt(metrics.at("mean_source_generated_token_count_gap_baseline"), metrics.at("mean_source_generated_token_count_gap_intervention"))], [Lower is better],
