...
The living context doc for a project's source data. Versioned and dated. Updated across the project's lifetime as phases surface new things.

File: `projects/<project>/REAL_DATA.md`
...
What's missing for the subprojects currently running or planned.
...
Links to subproject READMEs. One-line status each.
