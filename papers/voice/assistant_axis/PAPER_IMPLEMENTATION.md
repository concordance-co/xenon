...
The Llama 3.3 70B release is also packaged as a reusable source-controlled
asset manifest:

- manifest:
  `papers/voice/model_assets/vectors/assistant-axis/llama-3.3-70b/released/v1/manifest.toml`
- helper API: `papers.voice.assistant_axis.assets`
- shared artifact namespace:
  `/data/artifacts/model-assets/vectors/assistant-axis/llama-3.3-70b/released/v1`
