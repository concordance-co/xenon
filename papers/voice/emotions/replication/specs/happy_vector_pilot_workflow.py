...
MODAL_ARTIFACT_ROOT = "/data/artifacts/papers_voice_emotions_happy_vector_pilot"
LOCAL_ARTIFACT_ROOT = Path("artifacts") / "papers_voice" / "emotions_happy_vector_pilot"
LAYERS = (8, 16, 24, 32)
VALIDATION_LAYER = 24
