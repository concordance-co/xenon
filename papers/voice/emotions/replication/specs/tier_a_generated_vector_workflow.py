...
MODAL_ARTIFACT_ROOT = "/data/artifacts/papers_voice_emotions_tier_a_generated_vectors"
LOCAL_ARTIFACT_ROOT = Path("artifacts") / "papers_voice" / "emotions_tier_a_generated_vectors"
