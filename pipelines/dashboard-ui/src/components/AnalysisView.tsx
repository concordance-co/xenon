            ...
            <div className={s.configForm}>
              <div className={s.field}>
                <label className={s.fieldLabel}>
                  Target
                  <Tip text="What to predict from activations. decision_type: trade vs. observe. trade_side: buy vs. sell (trades only). executed_valence: sell=bearish, observe=neutral, buy=bullish. forced_observe: observation caused by no legal buy/sell path. risk_tolerance: low/mid/high (3-class). asset: which token was targeted or traded (multi-class)." />
                </label>
                <select
                ...
                >
                  ...
                  <option value="forced_observe">Forced Observe</option>
