...
def run_decision_structure_sanity_modal(
    ...
    from projects.DX_TERMINAL.decision_structure.sanity import (
...
def run_research_rerun_analysis_modal(
    ...
    from projects.DX_TERMINAL.research_rerun.analysis import (
...
def run_research_risk_geometry_analysis_modal(
    ...
    from projects.DX_TERMINAL.research_rerun.geometry import (
