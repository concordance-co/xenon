"""ARCH expected usage: fit persona vectors from a local capture artifact."""
...
def main() -> None:
    ...
    # Local fixture example. Shared project datasets should normally use
    # Dataset.from_postgres(..., source=PostgresSource.from_env(...)).
