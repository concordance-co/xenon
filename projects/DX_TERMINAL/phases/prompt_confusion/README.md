...
```text
projects/DX_TERMINAL/phases/prompt_confusion/specs/workflow.json
```
...
```bash
uv run -m pipelines.cli spec create --file projects/DX_TERMINAL/phases/prompt_confusion/specs/workflow.json
```
