...
def run_synthetic_policy_analysis_modal(
    ...
    from projects.DX_TERMINAL.phases.synthetic_market.synthetic_policy_analysis import (
...
def run_synthetic_market_transform_analysis_modal(
    ...
    from projects.DX_TERMINAL.phases.synthetic_market.synthetic_market_transform_analysis import (
...
def run_synthetic_market_discovery_analysis_modal(
    ...
    from projects.DX_TERMINAL.phases.synthetic_market.synthetic_market_discovery_analysis import (
...
def run_synthetic_market_context_order_analysis_modal(
    ...
    from projects.DX_TERMINAL.phases.synthetic_market.synthetic_market_context_order_analysis import (
