...
DEFAULT_INPUT = Path("projects/DX_TERMINAL/prompt_confusion/phase_04/outputs/phase_04_dataset/phase_04_dataset.jsonl")
DEFAULT_TABLE = "conflict_probe_examples_v3"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Upload the prompt-confusion Phase 04 dataset into Neon.")
