...
- artifact_id: `transfer_probe_1_17e2bf34`
- artifact_kind: `transfer_probe`
- provenance: run `wr_2e7479e82764_fd301702` / step `cross_dimension_similarity` / index `2`
- runtime: runner `modal` / app `ap-IbZyuzhnSjCtWwmmQ8RYPW`
