...
- artifact_id: `text_baseline_1_5670b0be`
- artifact_kind: `text_baseline`
- provenance: run `wr_f3fc218f0501_d358afa9` / step `text_baseline_conflict_strict_combined` / index `0`
- runtime: runner `modal` / app `ap-ZMSIFPLYDSQeBvMI8dsHu0`
...
- artifact_id: `probe_1_462f2357`
- artifact_kind: `probe`
- provenance: run `wr_f3fc218f0501_d358afa9` / step `probe_conflict_strict_combined_holdout` / index `2`
- runtime: runner `modal` / app `ap-HRHA3QLMs1qjZ1U9YThKNT`
