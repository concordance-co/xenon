...
"""Three-family geometry workflow for trade_size, risk_preference, and diversification_preference."""
...
PHASE_12_DATASET_PATH = Path(
    "projects/DX_TERMINAL/prompt_confusion/phase_12/outputs/phase_12_dataset/phase_12_dataset.jsonl"
)
DEFAULT_REPORT_DIR = "projects/DX_TERMINAL/prompt_confusion/phase_12/reports/three_family_geometry"
...
def _combined_records() -> list[dict[str, object]]:
    ...
    phase_12_rows = [
        row
        for row in _load_jsonl(PHASE_12_DATASET_PATH)
    ...
    if not phase_12_rows:
        raise ValueError("No settled diversification_preference rows found")
    return phase_09_rows + phase_10_rows + phase_12_rows
...
def build_dataset() -> Dataset:
    return Dataset.from_records(
        ...
        name="prompt_confusion_three_family_geometry",
    )
...
def build_runner_specs() -> dict[str, object]:
    ...
    return {
        ...
        "report_local": LocalRunnerSpec(
            artifacts=LocalArtifactStore(Path("artifacts") / "prompt_confusion_three_family_geometry"),
            catalog=build_prompt_confusion_catalog(__file__),
        ),
    }
        ...
        steps=(
            ...
            WorkflowStep(
                ...
                spec=TransferProbeSpec(
                    ...
                    cohort_values=("trade_size", "risk_preference", "diversification_preference"),
            ...
            WorkflowStep(
                ...
                spec=ReportSpec(
                    inputs=(
                        StepRef("cross_family_similarity"),
