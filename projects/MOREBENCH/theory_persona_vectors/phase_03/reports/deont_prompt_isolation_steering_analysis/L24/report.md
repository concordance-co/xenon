# Deont Prompt Isolation Steering Analysis L24

- Steering report: `projects/MOREBENCH/theory_persona_vectors/phase_03/reports/deont_prompt_isolation_steering/L24/report_bbb2000fbc3e_eb18fa1e`
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: |
| steer_deont01_on_neutral | N_neutral_iso_01 | P_deont_iso_01 | 0.200 | 0.200 | 0.016 | 0.004 | 0.100 |
| steer_deont02_on_neutral | N_neutral_iso_01 | P_deont_iso_02 | 0.233 | 0.167 | 0.032 | 0.011 | 0.133 |
| steer_generic_on_neutral | N_neutral_iso_01 | N_generic_moral_iso_01 | 0.167 | 0.333 | 0.006 | 0.004 | 0.100 |
| steer_random_on_neutral | N_neutral_iso_01 | None | 0.233 | 0.000 | 0.000 | 0.000 | 0.000 |
| steer_deont01_on_generic | N_generic_moral_iso_01 | P_deont_iso_01 | 0.100 | 0.100 | 0.012 | 0.004 | 0.033 |
| steer_deont02_on_generic | N_generic_moral_iso_01 | P_deont_iso_02 | 0.100 | 0.100 | -0.002 | -0.005 | 0.033 |
| steer_random_on_generic | N_generic_moral_iso_01 | None | 0.133 | 0.000 | 0.000 | 0.000 | 0.000 |
...
- `deont_pilot_004` baseline: Publish the documents immediately to inform the public and protect the source.
  ...
  reference: Publish the documents immediately.
  rec gain `0.202`, full-text gain `0.012`
- `deont_pilot_006` baseline: The official should clear the camp but provide temporary shelter for residents.
  patched: Clear the camp to save lives before the storm.
  reference: Clear the camp to save lives before the storm.
  rec gain `0.632`, full-text gain `0.165`
- `deont_pilot_007` baseline: Prioritize fixing the security weakness to prevent harm to users.
  patched: Prioritize fixing the security weakness to prevent potential harm.
  reference: Ship the accessibility feature.
  rec gain `-0.004`, full-text gain `0.003`
...
- `deont_pilot_004` baseline: Publish the documents immediately to inform the public and protect the source.
  patched: Publish the documents immediately to prevent harm.
  reference: Publish the documents immediately to prevent harm.
  rec gain `0.359`, full-text gain `0.295`
...
- `deont_pilot_004` baseline: Publish the documents immediately to inform the public and protect the source.
  ...
  rec gain `0.000`, full-text gain `0.000`
- `deont_pilot_006` baseline: The official should clear the camp but provide temporary shelter for residents.
  patched: Clear the camp to save lives, but provide immediate shelter and support.
  reference: 
  rec gain `0.000`, full-text gain `0.000`
- `deont_pilot_007` baseline: Prioritize fixing the security weakness to prevent harm to users.
  patched: Prioritize fixing the security weakness to prevent potential harm.
...
- `deont_pilot_016` baseline: Send the crew to the remote road to save the trapped family.
  ...
  rec gain `0.000`, full-text gain `0.044`
...
- `deont_pilot_023` baseline: Share the finding with caution and call for further testing.
  patched: Share the finding with authorities first to verify before public release.
  reference: Share the findings with authorities first to verify before public release.
  rec gain `0.396`, full-text gain `0.158`
...
- `deont_pilot_016` baseline: Send the crew to the remote road to save the trapped family.
  patched: Send the crew to the remote road to save the trapped family.
  reference: Send the crew to the remote road to save the trapped family.
  rec gain `0.000`, full-text gain `-0.112`
- `deont_pilot_017` baseline: Promote the employee who has been passed over to address inequities.
  patched: Promote the capable employee who has been passed over.
  reference: Promote the strongest performer.
  rec gain `0.048`, full-text gain `0.035`
- `deont_pilot_023` baseline: Share the finding with caution and call for further testing.
  patched: Share the finding with authorities first to verify before going public.
  reference: Share the finding with transparency and caution.
  rec gain `-0.087`, full-text gain `-0.132`
