...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build and upload the phase-9 set-geometry dataset.")
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("data/interp_exports/synthetic_market_phase9_set_geometry"),
        help="Local directory for phase-9 set-geometry artifacts.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--phase-name",
        default="phase9_set_geometry_v1",
...
def main() -> None:
    ...
    if args.log_id_base > 0:
        ...
        log_id_base = 2_147_110_000
    else:
        log_id_base = 2_147_100_000
