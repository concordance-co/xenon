...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build and upload the phase-11 set-geometry risk-ladder dataset.")
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("data/interp_exports/synthetic_market_phase11_set_geometry_risk_ladder"),
        help="Local directory for phase-11 set-geometry risk-ladder artifacts.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--phase-name",
        default="phase11_set_geometry_risk_ladder_v1",
