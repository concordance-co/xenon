...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build and upload the phase-14 set-geometry affordance-ladder dataset.")
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("data/interp_exports/synthetic_market_phase14_set_geometry_affordance_ladder"),
        help="Local directory for phase-14 set-geometry affordance-ladder artifacts.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--phase-name",
        default="phase14_set_geometry_affordance_ladder_v1",
...
def main() -> None:
    ...
    if args.log_id_base > 0:
        ...
        log_id_base = 2_147_255_000
    else:
        log_id_base = 2_147_250_000
