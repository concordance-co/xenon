...
Usage:
    modal run scripts/migrate_sqlite_to_neon.py
    modal run scripts/migrate_sqlite_to_neon.py --dry-run
    modal run scripts/migrate_sqlite_to_neon.py --skip-payloads  # skip gzip→JSONB (slow)
"""
