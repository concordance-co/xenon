...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build and upload the phase-8 contextual-relation dataset.")
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("data/interp_exports/synthetic_market_phase8_contextual_relation"),
        help="Local directory for phase-8 contextual-relation artifacts.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        default=4,
        help="Number of contextual roster variants to emit per scenario.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--phase-name",
        default="phase8_contextual_relation_v1",
...
def main() -> None:
    ...
    if args.log_id_base > 0:
        ...
        log_id_base = 2_147_060_000
    else:
        log_id_base = 2_147_050_000
