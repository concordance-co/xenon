...
- artifact_id: `transform_1_713b7197`
- artifact_kind: `transform`
- provenance: run `wr_2e37f6aad2d4_be02fc99` / step `steering_summary` / index `4`
- runtime: runner `modal` / app `ap-p2KGJyyuyKl4BHkzfp9Qee`
