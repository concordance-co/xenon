...
from projects.synthetic_market.synthetic_market_behavior_battery import SyntheticMarketBehaviorPlanItem
...
def test_matrix_runner_executes_multiple_cells_in_one_run(monkeypatch, tmp_path):
    import projects.synthetic_market.synthetic_market_behavior_matrix_runner as matrix_runner
